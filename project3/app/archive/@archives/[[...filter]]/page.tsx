  ...
  return (
    <>
      ...
      {findedData && <div className="">
        {findedData.map(elm => <div key={elm.newID} className="w-[90%]  bg-gray-800 mx-auto mt-12 rounded-2xl p-4">
          ...
          <div className="main flex flex-col gap-12 pt-12 text-left indent-3">
